...
<div class="right_col" role="main">
    <div class="">
        ...
        <!-- add new model -->
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".add-model">Tambah Model Baru</button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="gridSystemModalLabel">Tambah Model Baru</h4>
                    </div>
                <div class="modal-body">
                    <?php echo form_open_multipart('admin/car_model/addModel'); ?>
                            <fieldset>
                                <div class="form-group">
                                    <label for="model_name">Tambah Model:</label>
                                    <input type="text" class="form-control" name="model_name">
                                </div>
                                <div class="form-group">
                                   <label for="manufacturer_id"> Nama Pabrikan:</label>
                                ...
                                <div class="form-group">
                                    <label for="model_description">Deskripsi:</label>
                                    <textarea name="model_description" id="model_description"  rows="10" class="form-control summernote"></textarea>
                                </div>
                            
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary" name="buttonSubmit" value="Tambah Model">
                                </div>
                            </fieldset>         
                        </form>
                </div>
